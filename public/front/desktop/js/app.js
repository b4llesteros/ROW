...
/* harmony import */ var _contactform_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./contactform.js */ "./resources/js/front/contactform.js");
...
(0,_counter_js__WEBPACK_IMPORTED_MODULE_2__.renderCounter)(); // renderNotification();

(0,_faqs_js__WEBPACK_IMPORTED_MODULE_3__.renderFaqs)();
(0,_contactform_js__WEBPACK_IMPORTED_MODULE_4__.renderContactForm)();
...
/***/ "./resources/js/front/contactform.js":
/*!*******************************************!*\
  !*** ./resources/js/front/contactform.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "renderContactForm": () => (/* binding */ renderContactForm)
/* harmony export */ });
...
var renderContactForm = function renderContactForm() {
  // Es la caja que contiene todo el formulario
  //views->admin->layout->table_form.blade.php
  var formContainer = document.querySelector(".form-container"); //Es el botón de guardar del formulario
  //views->admin->components->savebutton.blade.php

  var storeButton = document.querySelector('.send-button'); //Es la etiqueta del formulario
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return fetch(url, {
                      ...
                      formContainer.innerHTML = json.form; //Se manda el evento renderFormModules para que se reactive el JavaScript

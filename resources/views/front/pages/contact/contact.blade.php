...
<head>
    <meta charset="utf-8">
		...
		<title>Contact - RoW</title>
		<meta name="description" content="Ducati - Made in Itali">
        <meta name="keywords" 	 content="Ducati,monster, multistrada, offroad, racing, Ducati Corse">
            ...
            <div class="desktop-one-column mobile-one-column">
                <div class="column">
                    <div class="navbar-right">                  
                            <ul>    
                                <li>
                                    <a href=""><svg class="home-icon" viewBox="0 0 24 24">
                    ...
                    <div class="contact-form">                    
                        <form>                         
                            ...
                            <div class="contact-form-element contact-form-element-button">    
                                <button class="contact-store">Enviar</button>
                            </div>                              
                        </form>                 
                    </div>
                </div>

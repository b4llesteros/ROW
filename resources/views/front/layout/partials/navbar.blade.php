        ...
        <div class="column">
            <div class="navbar">  
                <ul>    
                    ...
                    <li class="menu-option" data-url="{{route('front_products')}}"><h2>Products</h2></li> 
                    <li class="menu-option" data-url="{{route('front_cart')}}"><h2>Cart</h2></li>                                          
                    <li class="menu-option" data-url="{{route('front_contact')}}"><h2>Contact</h2></li>
                    <li class="menu-option" data-url="{{route('front_faqs')}}"><h2>Faqs</h2></li> 
                    <li>

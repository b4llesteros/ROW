        ...
        <div class="column">
            <div class="navbar-right">  
                <ul>    
                    ...
                    <li class="menu-option" data-url="{{route('front_faqs')}}">Faqs</li>                          
                    <li class="menu-option" data-url="{{route('front_cart')}}">Cart</li>                            
                    <li class="menu-option" data-url="{{route('front_products')}}">Products</li>                            
                    <li>

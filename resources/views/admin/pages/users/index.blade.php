                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-buttons">
                                <div class="table-button delete-button" data-url="{{route('users_destroy', ['user' => $user_element->id])}}">
                                ...
                                <div class="table-button edit-button" data-url="{{route('users_edit', ['user' => $user_element->id])}}">
                                    <svg  viewBox="0 0 24 24">
                                ...
                                <div class="content-question-answer">
                                    <div class="form-group">
                                        ...
                                        <div class="form-input">
                                            ...
                                            <input name="name" value="{{isset($user->name) ? $user->name:''}}"  class="input-question" placeholder="Escribe la pregunta">
                                        </div>
                                    </div>

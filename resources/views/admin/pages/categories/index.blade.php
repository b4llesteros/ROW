                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-buttons">
                                <div class="table-button delete-button" data-url="{{route('products_categories_destroy', ['category' => $category_element->id])}}">
                                ...
                                <div class="table-button edit-button" data-url="{{route('products_categories_edit', ['category' => $category_element->id])}}">
                                    <svg  viewBox="0 0 24 24">
                                            ...
                                            <div class="content-question-answer">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-input">                                                        
                                                        <input name="name" value="{{isset($category->name) ? $category->name:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-input">                                                       
                                                        <input name="title" value="{{isset($category->title) ? $category->title:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div>                                          
                                            </div>
                                        </div>

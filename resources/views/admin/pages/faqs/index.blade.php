            ...
            <div class="content content--active" data-tab="content">                
                <div class="desktop-one-column mobile-one-column"> 
                    ...
                    <form class="admin-form" action="{{route("faqs_store")}}">   
                        ...
                        <input type="hidden" name="id">  {{-- Este input es obligatorio en todo formualrio, como es de 
                            ...
                            <div class="content-question-answer">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <input name="name" id="name-input" class="input-question" placeholder="Escribe la pregunta">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-input">
                                        {{-- el atributo name tiene que ser lo mismo que el campo de la base de datos --}}
                                        <input name="title" id="name-input" class="input-question" placeholder="Escribe la pregunta">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-input">
                                        {{-- el atributo name tiene que ser lo mismo que el campo de la base de datos --}}
                                        <textarea class="ckeditor" id="name-input" name="description" placeholder="Escribe la respuesta"></textarea>
                                    </div>
                                </div>
                            </div>                                                                                                            
                        </div>

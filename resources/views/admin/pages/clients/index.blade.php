            ...
            @if(isset($clients))
                @foreach($clients as $client_element)
                    <tr>
                        ...
                        <td>{{$client_element->created_at}}</td>                        
                        <td>
                            <div class="table-buttons">
                                <div class="table-button delete-button" data-url="{{route('clients_destroy', ['client' => $client_element->id])}}">
                                ...
                                <div class="table-button edit-button" data-url="{{route('clients_edit', ['client' => $client_element->id])}}">
                                    <svg  viewBox="0 0 24 24">
                                            ...
                                            <div class="content-question-answer">                                               
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-input">                                                        
                                                        <input name="name" value="{{isset($client->name) ? $client->name:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-input">                                                       
                                                        <input name="surname" value="{{isset($client->surname) ? $client->surname:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-input">                                                        
                                                        <input name="email" value="{{isset($client->email) ? $client->email:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-input">                                                        
                                                        <input name="phone" value="{{isset($client->phone) ? $client->phone:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="form-label">
                                                    ...
                                                    <div class="form-input">                                                        
                                                        <input name="address" value="{{isset($client->address) ? $client->address:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div>   
                                                <div class="form-group">
                                                    <div class="form-label">
                                                    ...
                                                    <div class="form-input">                                                        
                                                        <input name="additional_information" value="{{isset($client->additional_information) ? $client->additional_information:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div>    
                                                <div class="form-group">
                                                    <div class="form-label">
                                                    ...
                                                    <div class="form-input">                                                        
                                                        <input name="city" value="{{isset($client->city) ? $client->city:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div>   
                                                <div class="form-group">
                                                    <div class="form-label">
                                                    ...
                                                    <div class="form-input">                                                        
                                                        <input name="state" value="{{isset($client->state) ? $client->state:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div>  
                                                <div class="form-group">
                                                    <div class="form-label">
                                                    ...
                                                    <div class="form-input">                                                        
                                                        <input name="zip_code" value="{{isset($client->zip_code) ? $client->zip_code:''}}"  class="input-form" placeholder="Escribe la pregunta">
                                                    </div>
                                                </div>                                                                                  
